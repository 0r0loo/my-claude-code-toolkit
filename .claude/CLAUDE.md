...
- 적용: `/feature`, `/fix`, `/migrate`에서 자연스럽게 작동
...
- 적용: `/review`, `/simplify`, `/retro`, `/canary`
...
작업 완료 후, 사용자의 현재 단계에 맞는 다음 커맨드를 **한 줄로** 제안한다.
강요하지 않고, "다음 단계로 `/review` 해보시겠어요?" 정도로 가볍게 안내한다.
